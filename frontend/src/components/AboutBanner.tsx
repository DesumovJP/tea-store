...
export default function AboutBanner({
  ...
  return (
    <Box sx={{ py: { xs: 4, md: 6 }, px: { xs: '1rem', md: '2.5rem' }, bgcolor: '#f8f9fa' }}>
      <Container maxWidth="lg" sx={{ p: 0 }}>
        <Box sx={{ position: "relative", width: "100%", height: { xs: 420, md: 520 }, overflow: "hidden" }}>
          <Box component="img" src={imageSrc} alt={title} sx={{ width: '100%', height: '100%', objectFit: 'cover' }} />
          {/* Faded overlay over background image */}
          <Box sx={{ position: 'absolute', inset: 0, bgcolor: 'rgba(126, 126, 126, 0.28)', pointerEvents: 'none' }} />

          {/* Grid overlay with two cards */}
          <Box sx={{ position: 'absolute', inset: 0, display: 'grid', gridTemplateColumns: { xs: '1fr', md: '3fr 2fr' }, alignItems: 'center', gap: { xs: 2, md: 3 }, px: { xs: 2, md: 3 } }}>
            {/* Stats card */}
            {stats?.length ? (
              <Box ref={statsRef} sx={{ 
                bgcolor: '#ffffff', 
                ...
                <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '1fr 1fr' }, gap: { xs: 2, md: 3 } }}>
                  <Box>
                    {stats.slice(0,3).map((s, idx) => {
                      ...
                      return (
                        <Box key={s.label} sx={{ display: 'flex', alignItems: 'baseline', gap: 1.5, mb: 2 }}>
                          <Typography component="span" className="hipster-heading" sx={{ 
                            fontWeight: 300, 
                            ...
                            {currentValues[idx]}
                            <Box component="span" sx={{ fontWeight: 800, ml: 0.25 }}>{parsed.suffix}</Box>
                          </Typography>
                          <Typography component="span" variant="body2" className="hipster-heading" sx={{ 
                            color: '#666666', 
                            letterSpacing: '-0.02em',
                            fontFamily: 'var(--font-space-grotesk), "Space Grotesk", "Inter", "Helvetica Neue", sans-serif',
                            textTransform: 'lowercase',
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%' }}>
                    <Box sx={{ textAlign: 'center', p: 2 }}>
                      <Typography className="hipster-heading" sx={{ 
                        fontWeight: 300, 
                        fontSize: { xs: '2rem', md: '2.5rem' }, 
                        lineHeight: 0.9, 
                        color: '#1a1a1a',
            ...
            <Box sx={{ display: 'grid', gridTemplateRows: 'auto auto', gap: { xs: 2, md: 2 } }}>
              <Box sx={{ 
                display: 'flex', 
                alignItems: 'center', 
                ...
                <Link href="https://instagram.com" aria-label="Instagram" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
                  <Box sx={{ 
                    display: 'inline-flex', 
                    alignItems: 'center', 
                    justifyContent: 'center', 
                ...
                <Link href="https://facebook.com" aria-label="Facebook" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
                  <Box sx={{ 
                    display: 'inline-flex', 
                    alignItems: 'center', 
                    justifyContent: 'center', 
                ...
                <Link href="https://youtube.com" aria-label="YouTube" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
                  <Box sx={{ 
                    display: 'inline-flex', 
                    alignItems: 'center', 
                    justifyContent: 'center', 
                ...
                <Link href="https://tiktok.com" aria-label="TikTok" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
                  <Box sx={{ 
                    display: 'inline-flex', 
                    alignItems: 'center', 
                    justifyContent: 'center', 
                ...
                <Link href="https://t.me" aria-label="Telegram" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
                  <Box sx={{ 
                    display: 'inline-flex', 
                    alignItems: 'center', 
                    justifyContent: 'center', 
              ...
              <Box sx={{ 
                ...
                <Typography variant="h5" className="hipster-heading" sx={{ 
                  fontWeight: 300, 
                  mb: { xs: 2, md: 2.5 },
                  fontFamily: '"Space Grotesk", "Inter", "Helvetica Neue", sans-serif',
                  textTransform: 'lowercase',
                ...
                <Typography variant="body2" className="hipster-heading" sx={{ 
                  opacity: 0.8, 
                  lineHeight: 1.6, 
                  mb: { xs: 2.5, md: 3 },
                  fontFamily: '"Space Grotesk", "Inter", "Helvetica Neue", sans-serif',
